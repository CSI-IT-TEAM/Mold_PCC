...
namespace FORM
{
    public partial class MOLD_PCC_LOCATION_POPUP : Form
    {
        public MOLD_PCC_LOCATION_POPUP()
        {
            InitializeComponent();
        }
        ...
        private async void SetData()
        {
            try
            {
                gridControl1.DataSource = await SEL_MOLD_LOCTED_POP_DETAIL(_location);
        ...
        #region DB
        private async Task<DataTable> SEL_MOLD_LOCTED_POP_DETAIL(string arg_Located)
        {
            return await Task.Run(() => {
                try
                {
                    ...
                    string process_name = "PKG_MSPD_MOLD_PCC_WMS.SEL_MOLD_LOCTED_POP_DETAIL";
